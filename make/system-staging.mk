SYSTEM_STAGING_DEPENDENCIES = $(KERNEL_BIN) $(PORTAL_ELF) $(NETGET_ELF) $(HELLO_ELF) $(TICTACTOE_ELF) $(TERMTACTICS_ELF) $(INPUTINFO_ELF) $(MEMORY_SMOKE_ELF) $(MASTER_ELF) $(SLAVE_ELF) $(MODULE_HOST_ELF) $(MODULE_SAMPLE_ELF) $(MODULE_IMPORT_ELF) $(PIPE_SOURCE_ELF) $(PIPE_UPPER_ELF) $(PIPE_SUMMARY_ELF) $(TINYGL_DEMO_ELF) $(SYSTEM_TEST_EPK) $(SYSTEM_SCRIPT_FILES) $(TCC_SAMPLE_FILES) $(TCC_INCLUDE_FILES) $(RUNTIME_INCLUDE_FILES) $(RUNTIME_INCLUDE_SYS_FILES) $(TCC_CRT1_OBJ) $(TCC_CRTI_OBJ) $(TCC_CRTN_OBJ) $(TCC_LIBC_A) $(TCC_LIBC_MIT_LICENSE)
...
define STAGE_SYSTEM_EXT2_TREE
	...
	@cp $(TINYGL_DEMO_ELF) $1/exos/apps/tinygl-demo
